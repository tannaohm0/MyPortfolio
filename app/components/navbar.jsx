...
import { FaLaptopCode } from "react-icons/fa"; // Import the computer icon
    ...
    <nav className="bg-transparent">
      <div className="flex items-center justify-between py-5">
        <div className="flex flex-shrink-0 items-center">
          <Link href="/" className="flex items-center text-[#16f2b3] text-3xl font-bold space-x-2">
            <FaLaptopCode className="text-[#16f2b3] text-4xl" /> {/* Computer icon */}
            <span>Tanna Ohm</span>
          </Link>
        </div>
